...
public class PRK0001$Controller extends SetLogger {
	...
	public @ResponseBody Map<String, Object> parkingInsert(@RequestBody List<PrkplceCellMngVO> list) {
	...
	public @ResponseBody Map<String, Object> parkingSelect(@RequestBody PrkplceCellMngVO vo) {
		Map<String,Object> returnMap = new HashMap<String,Object>();
		logger.debug("####### vo ==> {}" , vo );
